...
# 载入背景图
background = pygame.image.load('static/images/airbj.jpg')
# 游戏结束图
gameover = pygame.image.load('static/images/airplane.jpg')  # new

# 载入资源图片
shoot_img = pygame.image.load('static/images/taotubj.png')
